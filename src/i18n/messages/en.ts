...
export const en = {
  ...
  'chat.progressCampaign': 'Campaign selected',
  'chat.progressCampaignCreate': 'Campaign created',
  'chat.progressBrand': 'Brand Identity applied',
  'chat.progressAssets': 'Relevant assets selected',
  'chat.progressConcepts': 'Poster concepts prepared',
  'chat.progressPoster': 'Generating poster {index} of {total}',
  'chat.progressPosterDone': 'Poster {index} of {total} created',
  'chat.progressPosterFailed': 'Poster {index} of {total} couldn’t be completed',
  'chat.progressFailed': 'Couldn’t be completed',
  ...
  'chat.viewAllCreatives': 'View all creatives',
  ...
  'brand.detectedLogoAlt': 'Logo EVA found',
  'brand.detectedFontHint': 'Your brand uses {font} — pick the closest match below.',
  'brand.useThese': 'Use these',
  'brand.changeDetected': 'Change',
  // Business DNA (Phase 7E): source-neutral detected card + sources card.
  'brand.detectedTitleSources': 'EVA found these from your business sources',
  'brand.detectedSourcesLabel': 'Sources analyzed:',
  'brand.detectedCategory': 'Business type: {category}',
  'brand.detectedFontSupported': 'Your brand uses {font} — EVA can set it as your font.',
  'brand.detectedFontUnsupported':
    'Your brand uses {font}. It isn’t in EVA’s font list yet, so pick the closest match below — EVA won’t swap it for you.',
  ...
  'brand.sourceAssets': '{count} uploaded assets',
  'brand.sourceAssetOne': '1 uploaded asset',
  'brand.sourceLimited': 'limited access',
  'brand.sourceInaccessible': 'not accessible',
  'brand.sourceFailed': 'could not read',
  'brand.sourcesTitle': 'Business sources',
  'brand.sourcesHint':
    'EVA reads your website, Facebook Page, Instagram and uploaded assets to understand your business and brand. A website is optional.',
  'brand.sourcesNone':
    'No sources yet. Add a link below or upload a few assets, then EVA can analyse your business.',
  'brand.sourcesAddPlaceholder': 'Paste a website, Facebook Page or Instagram link',
  'brand.sourcesAdd': 'Add link',
  'brand.sourcesTooMany': 'You can add up to 3 links per analysis.',
  'brand.sourcesDuplicate': 'That link is already on the list.',
  'brand.sourcesAnalyse': 'Analyse with EVA',
  'brand.sourcesReanalyse': 'Analyse again',
  'brand.sourcesAnalysing': 'EVA is analysing your business…',
  'brand.sourcesLastAnalysed': 'Last analysed {when}.',
  'brand.sourcesApplied': 'Applied to your Brand Identity.',
  'brand.sourcesPartial':
    'EVA could only access limited public information from some sources. You can tell EVA more in chat.',
  'brand.sourcesFailed': 'EVA couldn’t analyse your business right now.',
  'brand.sourcesRetry': 'Try again',
  'brand.sourcesRemoveLink': 'Remove {link}',
