...
export default function BusinessPage() {
  ...
  return (
    // The shell's main region is the page scroller (Phase 7G). `relative`
    // keeps absolutely positioned descendants — the screen-reader-only file
    // input in the logo section among them — inside this page rather than
    // the document, so a tall page never grows the document behind the shell.
    <div className="relative">
